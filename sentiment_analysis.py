...
def analyze_sentiment(review_text: str) -> tuple[float, str]:
    ...
    Returns:
        tuple[float, str]: A tuple containing the polarity score and the sentiment label ('positive', 'negative', or 'neutral').
    """
...
if __name__ == "__main__":
    ...
    sentiment_output_filename = "reviews_with_sentiment.csv"
    ...
    try:
        ...
        # Use .apply() to create new columns based on the function's tuple output
        ...
        print("Please ensure 'cleaned_reviews.csv' exists after running preprocess_data.py.")
